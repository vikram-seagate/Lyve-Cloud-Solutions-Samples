...
function GoogleMigrationTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Migration Task Details"} bordered>
                ...
                <Descriptions.Item label={"Google Bucket"} span={2}>{source_bucket}</Descriptions.Item>
                <Descriptions.Item label={"Object Key"} span={3}>{source_obj_key}</Descriptions.Item>
...
export default GoogleMigrationTaskDetailDrawer;