...
function AlibabaMigrationTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Migration Task Details"} bordered>
                <Descriptions.Item label="Source Region">{source_region}</Descriptions.Item>
...
export default AlibabaMigrationTaskDetailDrawer;