...
function MigrationTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Migration Task Details"} bordered>
                <Descriptions.Item label="Source Endpoint" span={3}>{source_endpoint}</Descriptions.Item>
                <Descriptions.Item label={"Source Bucket"}>{source_bucket}</Descriptions.Item>
                <Descriptions.Item label={"Source Object Key"} span={2}>{source_obj_key}</Descriptions.Item>
                <Descriptions.Item label={"Lyve Cloud Region"} span={3}>{destination_region}</Descriptions.Item>
                <Descriptions.Item label={"Destination Bucket"}>{destination_bucket}</Descriptions.Item>
                <Descriptions.Item label={"Destination Folder"} span={2}>{destination_key}</Descriptions.Item>
...
export default MigrationTaskDetailDrawer;