...
function AzureSyncTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Synchronization Task Details"} bordered>
                <Descriptions.Item label={"Source Container"} span={3}>{source_container}</Descriptions.Item>
...
export default AzureSyncTaskDetailDrawer;