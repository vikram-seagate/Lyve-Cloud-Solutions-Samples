...
import syncTaskTableColumns from "./GoogleSyncTaskTableColumns";
import syncJobTableColumns from "./GoogleSyncJobTableColumns";
import GoogleSyncJobDetailDrawer from "./GoogleSyncJobDetailDrawer";
import GoogleSyncTaskDetailDrawer from "./GoogleSyncTaskDetailDrawer";
...
function GoogleSynchronizationProgressMonitor({syncTasks, syncJobs}) {
    ...
    return <div>
        ...
        <Table dataSource={filterTasks(filters, syncJobs)} columns={syncJobTableColumns(setJobToView)} size={"small"}
               pagination={{position: ["bottomLeft"], defaultPageSize: 100}}/>
        <GoogleSyncTaskDetailDrawer setTaskToView={setTaskToView} taskToView={taskToView}/>
        <GoogleSyncJobDetailDrawer setJobToView={setJobToView} jobToView={jobToView}/>
    </div>;
}

export default GoogleSynchronizationProgressMonitor;