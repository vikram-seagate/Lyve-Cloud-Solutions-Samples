...
function AlibabaSyncTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Synchronization Task Details"} bordered>
                <Descriptions.Item label="Source Region" span={2}>{source_region}</Descriptions.Item>
...
export default AlibabaSyncTaskDetailDrawer;