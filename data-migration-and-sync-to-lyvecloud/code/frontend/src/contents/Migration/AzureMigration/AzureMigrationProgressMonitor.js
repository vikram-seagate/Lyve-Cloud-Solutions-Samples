...
import AzureMigrationTaskDetailDrawer from "./AzureMigrationTaskDetailDrawer";
import azureMigrationTaskTableColumns from "./AzureMigrationTaskTableColumns";
...
function AzureMigrationProgressMonitor({tasks}) {
    ...
    return <div>
        ...
        <Table dataSource={filterTasks(filters, tasks)} columns={azureMigrationTaskTableColumns(setTaskToView)}
               size={"small"}
               pagination={{position: ["bottomLeft"], defaultPageSize: 100}}/>
        <AzureMigrationTaskDetailDrawer setTaskToView={setTaskToView} taskToView={taskToView}/>
    </div>;
}

export default AzureMigrationProgressMonitor;