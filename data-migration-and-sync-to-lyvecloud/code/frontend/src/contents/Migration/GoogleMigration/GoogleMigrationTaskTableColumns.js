...
const googleMigrationTaskTableColumns = (setTaskToView) => [
    {
        title: "Updated At",
    ...
    {
        title: "Project ID", dataIndex: "source_project_id", key: "source_project_id"
    },
    {
...
export default googleMigrationTaskTableColumns;