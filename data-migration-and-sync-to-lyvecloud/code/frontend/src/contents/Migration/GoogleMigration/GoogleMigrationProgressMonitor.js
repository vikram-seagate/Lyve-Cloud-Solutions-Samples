...
import GoogleMigrationTaskDetailDrawer from "./GoogleMigrationTaskDetailDrawer";
import googleMigrationTaskTableColumns from "./GoogleMigrationTaskTableColumns";
...
function GoogleMigrationProgressMonitor({tasks}) {
    ...
    return <div>
        ...
        <Table dataSource={filterTasks(filters, tasks)} columns={googleMigrationTaskTableColumns(setTaskToView)}
               size={"small"}
               pagination={{position: ["bottomLeft"], defaultPageSize: 100}}/>
        <GoogleMigrationTaskDetailDrawer setTaskToView={setTaskToView} taskToView={taskToView}/>
    </div>;
}

export default GoogleMigrationProgressMonitor;