...
const alibabaMigrationTaskTableColumns = (setTaskToView) => [{
    title: "Updated At",
    dataIndex: "updated_at",
    sorter: (a, b) => Date.parse(a.updated_at) - Date.parse(b.updated_at),
    render: utcString => moment(utcString).calendar()
}, {
    title: "Source Region", dataIndex: "source_region", key: "source_region",
}, {
...
export default alibabaMigrationTaskTableColumns;