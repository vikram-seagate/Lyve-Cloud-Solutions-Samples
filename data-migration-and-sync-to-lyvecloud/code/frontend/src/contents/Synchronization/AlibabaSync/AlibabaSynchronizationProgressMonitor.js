...
import syncTaskTableColumns from "./AlibabaSyncTaskTableColumns";
import syncJobTableColumns from "./AlibabaSyncJobTableColumns";
import AlibabaSyncJobDetailDrawer from "./AlibabaSyncJobDetailDrawer";
import AlibabaSyncTaskDetailDrawer from "./AlibabaSyncTaskDetailDrawer";
...
function AlibabaSynchronizationProgressMonitor({syncTasks, syncJobs}) {
    ...
    return <div>
        ...
        <Table dataSource={filterTasks(filters, syncJobs)} columns={syncJobTableColumns(setJobToView)} size={"small"}
               pagination={{position: ["bottomLeft"], defaultPageSize: 100}}/>
        <AlibabaSyncTaskDetailDrawer setTaskToView={setTaskToView} taskToView={taskToView}/>
        <AlibabaSyncJobDetailDrawer setJobToView={setJobToView} jobToView={jobToView}/>
    </div>;
}

export default AlibabaSynchronizationProgressMonitor;