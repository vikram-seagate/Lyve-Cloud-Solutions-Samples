...
function GeneralS3SyncTaskDetailDrawer({taskToView, setTaskToView}) {
    ...
    if (taskToView) {
        ...
        drawerBody = <div>
            <Descriptions title={"Synchronization Task Details"} bordered>
                <Descriptions.Item label="Source Endpoint" span={2}>{source_endpoint}</Descriptions.Item>
                <Descriptions.Item label={"Source Bucket"}>{source_bucket}</Descriptions.Item>
                <Descriptions.Item label={"Lyve Cloud Region"} span={2}>{destination_region}</Descriptions.Item>
...
export default GeneralS3SyncTaskDetailDrawer;