...
import syncTaskTableColumns from "./GeneralS3SyncTaskTableColumns";
import syncJobTableColumns from "./GeneralS3SyncJobTableColumns";
import GeneralS3SyncJobDetailDrawer from "./GeneralS3SyncJobDetailDrawer";
import GeneralS3SyncTaskDetailDrawer from "./GeneralS3SyncTaskDetailDrawer";
...
function GeneralS3MigrationProgressMonitor({syncTasks, syncJobs}) {
    ...
    return <div>
        ...
        <Table dataSource={filterTasks(filters, syncJobs)} columns={syncJobTableColumns(setJobToView)} size={"small"}
               pagination={{position: ["bottomLeft"], defaultPageSize: 100}}/>
        <GeneralS3SyncTaskDetailDrawer setTaskToView={setTaskToView} taskToView={taskToView}/>
        <GeneralS3SyncJobDetailDrawer setJobToView={setJobToView} jobToView={jobToView}/>
    </div>;
}

export default GeneralS3MigrationProgressMonitor;